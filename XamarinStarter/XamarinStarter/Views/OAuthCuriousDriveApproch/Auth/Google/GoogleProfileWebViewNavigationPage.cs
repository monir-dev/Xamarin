...
namespace XamarinStarter.Views.Auth.Google
{
    public class GoogleProfileWebViewNavigationPage : ContentPage
    {

        private readonly GoogleViewModel _googleViewModel = new GoogleViewModel();

        public GoogleProfileWebViewNavigationPage()
        {
            ...
            var authRequest =
                  ...
                  + "&client_id=" + Constants.GoogleAndroidClientId;
